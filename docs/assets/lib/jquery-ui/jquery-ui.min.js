...
!(function (t) {
  ...
  (x = Math.max),
    ...
    (V.position = {
      ...
      getScrollInfo: function (t) {
        ...
        return {
          width:
            'scroll' === i || ('auto' === i && t.height < t.element[0].scrollHeight) ? V.position.scrollbarWidth() : 0,
            ...
            (m.fn[a] = function (t) {
              ...
              return 'undefined' === i
                ...
                : ('function' === i && (i = P((t = t.call(this, o)))),
                  null == t && r.empty
                    ? this
                    : ('string' === i && (e = f.exec(t)) && (t = o + parseFloat(e[2]) * ('+' === e[1] ? 1 : -1)),
                      (n[r.idx] = t),
                      this[s](n)));
            });
        });
  ...
  (V.effects = { effect: {} }),
    ...
    (V.fx.step.clip = function (t) {
      t.clipInit ||
        ((t.start = V(t.elem).cssClip()), 'string' == typeof t.end && (t.end = G(t.end, t.elem)), (t.clipInit = !0)),
        V(t.elem).cssClip({
  ...
  (y = V.effects),
    ...
    V.effects.define('size', function (s, e) {
      ...
      V.effects.createPlaceholder(i),
        ...
        ('box' !== h && 'both' !== h) ||
          (n.from.y !== n.to.y &&
            ((f = V.effects.setTransition(i, o, n.from.y, f)), (g = V.effects.setTransition(i, o, n.to.y, g))),
          n.from.x !== n.to.x &&
            ((f = V.effects.setTransition(i, a, n.from.x, f)), (g = V.effects.setTransition(i, a, n.to.x, g)))),
        ('content' !== h && 'both' !== h) ||
          (n.from.y !== n.to.y &&
            ((f = V.effects.setTransition(i, t, n.from.y, f)), (g = V.effects.setTransition(i, t, n.to.y, g)))),
        c &&
        ...
        ('content' !== h && 'both' !== h) ||
          ...
          i.find('*[width]').each(function () {
            ...
            n.from.y !== n.to.y &&
              ((i = V.effects.setTransition(t, o, n.from.y, i)), (e = V.effects.setTransition(t, o, n.to.y, e))),
              n.from.x !== n.to.x &&
                ((i = V.effects.setTransition(t, a, n.from.x, i)), (e = V.effects.setTransition(t, a, n.to.x, e))),
  ...
  (V.ui.keyCode = {
    ...
    V.widget('ui.accordion', {
      ...
      _activate: function (t) {
        ...
        t !== this.active[0] &&
          ((t = t || this.active[0]), this._eventHandler({ target: t, currentTarget: t, preventDefault: V.noop }));
      },
    ...
    _updateIcon: function (t, e) {
      ...
      this.icon
        ...
        t
          ...
          : (this.iconSpace ||
              ((this.iconSpace = V('<span> </span>')), this._addClass(this.iconSpace, 'ui-button-icon-space')),
  ...
  V.extend(V.ui, { datepicker: { version: '1.13.1' } }),
    V.extend(st.prototype, {
          ...
          switch (t.keyCode) {
            ...
            case 33:
              V.datepicker._adjustDate(
                t.target,
                t.ctrlKey ? -V.datepicker._get(s, 'stepBigMonths') : -V.datepicker._get(s, 'stepMonths'),
                'M'
              );
              break;
            case 34:
        ...
        'input' !== (t = t.target || t).nodeName.toLowerCase() && (t = V('input', t.parentNode)[0]),
          V.datepicker._isDisabledDatepicker(t) ||
            ...
            !1 !== (i = (s = V.datepicker._get(n, 'beforeShow')) ? s.apply(t, [t, n]) : {}) &&
              ...
              V.datepicker._pos ||
                ((V.datepicker._pos = V.datepicker._findPos(t)), (V.datepicker._pos[1] += t.offsetHeight)),
              (e = !1),
              V(t)
                .parents()
                .each(function () {
      ...
      _attachHandlers: function (t) {
        ...
        t.dpDiv.find('[data-handler]').map(function () {
          var t = {
            ...
            selectDay: function () {
              return (
                V.datepicker._selectDay(i, +this.getAttribute('data-month'), +this.getAttribute('data-year'), this), !1
              );
            },
      ...
      _generateHTML: function (t) {
        ...
        if ((K < 0 && ((K += 12), U--), q))
          for (
            e = this._daylightSavingAdjust(new Date(q.getFullYear(), q.getMonth() - L[0] * L[1] + 1, q.getDate())),
              e = j && e < j ? j : e;
        ...
        for (
          ...
          for (_ = '', this.maxRows = 4, v = 0; v < L[1]; v++) {
            if (
              ((b = this._daylightSavingAdjust(new Date(U, K, t.selectedDay))), (y = ' ui-corner-all'), (w = ''), Y)
            ) {
            ...
            11 < ++K && ((K = 0), U++),
              (_ += w +=
                '</tbody></table>' +
                (Y
                  ? '</div>' + (0 < L[0] && v === L[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                  : ''));
          }
          f += _;
        }
        ...
        if ((m || (b += y + (!o && f && g ? '' : '&#xa0;')), !t.yearshtml))
          if (((t.yearshtml = ''), o || !g)) b += "<span class='ui-datepicker-year'>" + i + '</span>';
            ...
            for (
              ...
              t.yearshtml +=
                "<option value='" + d + "'" + (d === i ? " selected='selected'" : '') + '>' + d + '</option>';
            ...
            e._intersectsWith(e.containerCache) &&
              ...
              V.each(n.sortables, function () {
                return (
                  ...
                  (t =
                    this !== e && this._intersectsWith(this.containerCache) && V.contains(e.element[0], this.element[0])
                      ? !1
                      : t)
                );
              })),
                ...
                !0 === r.options.range &&
                  ('horizontal' === r.orientation
                    ? (0 === t && r.range.stop(1, 1)[l ? 'animate' : 'css']({ left: i + '%' }, a.animate),
                      1 === t &&
                        r.range[l ? 'animate' : 'css']({ width: i - e + '%' }, { queue: !1, duration: a.animate }))
                    : (0 === t && r.range.stop(1, 1)[l ? 'animate' : 'css']({ bottom: i + '%' }, a.animate),
                      1 === t &&
                        r.range[l ? 'animate' : 'css']({ height: i - e + '%' }, { queue: !1, duration: a.animate }))),
                (e = i);
            })
          : ((t = this.value()),
            (s = this._valueMin()),
    ...
    V.widget('ui.sortable', V.ui.mouse, {
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              V.contains(this.containers[u].element[0], this.items[e].item[0]) &&
                ...
                Math.abs(t[h] - a) < i &&
                  ((i = Math.abs(t[h] - a)), (s = this.items[e]), (this.direction = r ? 'up' : 'down')));
      ...
      _convertPositionTo: function (t, e) {
        ...
        var i = 'absolute' === t ? 1 : -1,
          s =
            'absolute' !== this.cssPosition ||
            (this.scrollParent[0] !== this.document[0] && V.contains(this.scrollParent[0], this.offsetParent[0]))
              ? this.scrollParent
              : this.offsetParent,
    ...
    _events: {
      ...
      'mouseenter .ui-spinner-button': function (t) {
        if (V(t.currentTarget).hasClass('ui-state-active'))
          return (
            !1 !== this._start(t) && void this._repeat(null, V(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t)
          );
      },
  ...
  V.widget('ui.tabs', {
    ...
    _getIndex: function (t) {
      return (t =
        'string' == typeof t ? this.anchors.index(this.anchors.filter("[href$='" + V.escapeSelector(t) + "']")) : t);
    },
    _destroy: function () {
      this.xhr && this.xhr.abort(),
        ...
        t &&
          ...
          e.parents().each(function () {
            ...
            e.data('ui-tooltip-open') && (((t = V.Event('blur')).target = t.currentTarget = this), i.close(t, !0)),
              e.attr('title') &&
                (e.uniqueId(), (i.parents[this.id] = { element: this, title: e.attr('title') }), e.attr('title', ''));
          }),
      ...
      V.each(this.tooltips, function (t, e) {
        ...
        (i.target = i.currentTarget = e[0]),
          ...
          e.data('ui-tooltip-title') &&
            (e.attr('title') || e.attr('title', e.data('ui-tooltip-title')), e.removeData('ui-tooltip-title'));
      }),
        this.liveRegion.remove();
    },
  }),
